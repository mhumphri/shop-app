        ...
        <nav className="search-map-nav-sd3" onClick={countrySearch}>
          ...
          <div className="search-map-nav-ie1">
            ...
            >
              <div>
                <div class="search-map-nav-snp">Country</div>
                <div class="search-map-nav-1yi">{props.searchLocation.length>0 ? props.searchLocation : <span className="search-map-nav-ds1">Search countries</span>} </div>
              </div>
            </label>
          </div>
          <div className="search-map-nav-ll9">
            <div
              class="search-map-nav-ah2"
            >
