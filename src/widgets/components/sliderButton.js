  ...
  return (
    <>
      <button
        type="button"
        className={
          props.narrowTrack ? "rangeslider-pu5 narrow-track" : "rangeslider-pu5"
        }
        role="slider"
        style={{
      ...
      >
        {props.labelDisabled ? null : (
          <div
            className={
              props.buttonDrag || buttonHover
                ? "rangeslider-ja5"
                : "rangeslider-ja5 hidden"
            }
          >
            {props.buttonPos.toFixed(0)}
          </div>
        )}
      </button>
    </>
