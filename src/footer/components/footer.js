...
function Footer(props) {
  return (
    <footer className="footer-ie4">
      <div className={props.productPage ? "footer-hr0 product-page" : "footer-hr0"}>
        <div className="footer-hq7">© 2023 Kurashi Creations</div>
        <div className="footer-nw3">
          <a
            rel="noopener noreferrer"
            target="_blank"
            href="https://www.instagram.com/kurashi_creations"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 32 32"
              className="footer-la1"
